...
class JsonProcessor:
    ...
    def json_schema_validator(self):
        try:
            ...
            # Now, call the CSV processing methods with the text from the JSON
...
# Прочитаем данные из JSON и запишем их в News.txt
...
# Прочитаем данные из News.txt, проверим их формат и запишем в Processed_News.txt
...
# Обработаем файл Processed_News.txt с помощью CsvProcessor
csv_processor = CsvProcessor()
